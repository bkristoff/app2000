...
function lastFraLager() {
    ...
    const data = JSON.parse(raatekst);
    if (!Array.isArray(data))
        return [];
    return data.filter((o) => typeof o === "object" &&
        o !== null &&
        typeof o.id === "number" &&
